...
- `backend-tdd-ddd-eda-flow--백엔드-tdd-ddd-eda-흐름.md`: 리뷰 기능 예제로 TDD, DDD, EDA를 처음부터 끝까지 따라가는 튜토리얼
...
- `frontend-verification--프론트엔드-검증.md`: 실제 브라우저에서 프론트 기능이 깨지지 않는지 확인하는 방식
